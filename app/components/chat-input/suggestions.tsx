...
export const Suggestions = memo(function Suggestions({
  ...
  const suggestionsGrid = useMemo(
    () => {
      if (!mounted) {
        return (
          <div className="flex w-full max-w-full flex-nowrap justify-start gap-2 overflow-x-auto px-2 md:mx-auto md:max-w-2xl md:flex-wrap md:justify-center md:pl-0">
            {SUGGESTIONS_CONFIG.map((suggestion) => (
              <PromptSuggestion
